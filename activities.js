    ...
    },
{
...

  {
    ...
    univers: ["gastronomie", "culture", "evenementiel"],
    format: ["demijournee"],
    saison: ["toutesaisons"],
    env: ["outdoor"],
    prixMin: 35,
  ...
  },
  {
    ...
    revendiquee: false,
    offre: "gratuit",
    title: "Karting Extérieur — Sundgau Kart",
    location: "Saint-Louis",
    lat: 47.5741,
    lng: 7.5124,
    description: "1 400 mètres de piste outdoor, des lignes droites pour lâcher les chevaux et des épingles qui sélectionnent les vrais pilotes. Le Sundgau Kart propose un format team building taillé pour les groupes qui veulent du challenge sans se prendre au sérieux : chaque équipe affronte la piste, les chronos font foi, et le débrief se passe souvent autour d'un fou rire. Accessible dès 17€, adapté aux débutants comme aux groupes compétitifs, c'est l'activité outdoor adrénaline par excellence en Alsace.",
  ...
  },
  {
    ...
    univers: ["sport", "jeux", "evenementiel"],
    format: ["demijournee"],
    saison: ["toutesaisons"],
    env: ["indoor"],
    prixMin: 25,
