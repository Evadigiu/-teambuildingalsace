...
},
{
  ...
  revendiquee: false,
  offre: "gratuit",
  title: "Séminaire aventure en pleine nature",
  location: "La Bresse",
  lat: 48.0007,
  lng: 6.8748,
  description: "Organisez un séminaire d'entreprise au cœur des Vosges dans un environnement naturel entièrement dédié à la cohésion d'équipe. Ce concept combine salles de réunion équipées, hébergements insolites, restauration locale et activités outdoor pour créer une expérience complète. Fantasticable®, Explor Games®, randonnée, biathlon, VTT électrique, gyropode ou encore observation de la faune rythment un programme sur mesure favorisant la communication, la cohésion et le dépassement de soi. Une formule idéale pour les entreprises souhaitant alterner temps de travail et activités de team building dans un cadre exceptionnel.",
  univers: ["nature", "sport"],
  objectifs: ["cohesion", "communication", "leadership"],
  ambiances: ["nature", "challenge"],
  env: ["outdoor"],
  format: ["journee", "multijours"],
  saison: ["toutesaisons"],
  prixMin: 90,
  ...
  duree: "1 à 3 jours",
  emoji: "🌲",
  gradient: "linear-gradient(135deg, #355C3D, #A8C66C)",
  image: "images/boldair.webp",
  tags: [
    { label: "Nature", cls: "cat-nature" },
    { label: "Challenge", cls: "cat-challenge" },
    { label: "Leadership", cls: "cat-leadership" },
...
},
{
  ...
  revendiquee: false,
  offre: "gratuit",
  title: "Atelier d'impression textile & patrimoine",
  location: "Husseren-Wesserling",
  lat: 47.8854,
  lng: 6.9996,
  description: "Offrez à vos équipes une immersion originale au cœur du patrimoine industriel alsacien. Entre visite d’un Château, découverte des jardins remarquables et atelier d'impression textile à la planche, les participants plongent dans l'histoire de la célèbre manufacture tout en réalisant leur propre création. Cette expérience culturelle et créative favorise les échanges, stimule la créativité et offre un moment de cohésion dans un cadre historique exceptionnel. Une activité idéale pour compléter un séminaire ou organiser un team building culturel en Alsace.",
  univers: ["creatif", "culture"],
  objectifs: ["cohesion", "communication", "innovation"],
  ambiances: ["creatif", "culture"],
  env: ["indoor", "outdoor"],
  format: ["demijournee"],
  ...
  duree: "1h30 à 3h",
  emoji: "🎨",
  gradient: "linear-gradient(135deg, #8E6E53, #D9B382)",
  image: "images/wesserling.webp",
  tags: [
    { label: "Créatif", cls: "cat-creatif" },
    { label: "Innovation", cls: "cat-innovation" },
    { label: "Culture & Patrimoine", cls: "cat-culture" },
    { label: "Cohésion", cls: "cat-cohesion" },
    { label: "Indoor", cls: "cat-indoor" },
    { label: "Outdoor", cls: "cat-outdoor" }
...
},
{
  ...
  revendiquee: false,
  offre: "gratuit",
  title: "Balade en canoë dans le Grand Ried",
  location: "Sélestat",
  lat: 48.2559,
  lng: 7.4546,
  description: "Offrez à vos collaborateurs une parenthèse nature au fil de l'eau avec une balade en canoë au cœur du Grand Ried d'Alsace. Accessible à tous, cette activité permet de découvrir une biodiversité exceptionnelle tout en partageant un moment convivial en équipe. Les parcours, de la demi-journée à la journée complète, favorisent les échanges, la coopération et la déconnexion dans un environnement préservé. Une expérience idéale pour un team building outdoor, un séminaire au vert ou une journée de cohésion en pleine nature.",
  univers: ["nature", "bienetre"],
  objectifs: ["cohesion", "communication", "stress"],
  ambiances: ["nature", "bienetre"],
  env: ["outdoor"],
  format: ["demijournee", "journee"],
  ...
  duree: "2h à 6h",
  emoji: "🛶",
  gradient: "linear-gradient(135deg, #2C7DA0, #76C893)",
...
},
{
  ...
  revendiquee: false,
  offre: "gratuit",
  title: "Aventure souterraine & défis miniers",
  location: "Sainte-Marie-aux-Mines",
  lat: 48.2468,
  lng: 7.1817,
  description: "Vivez un team building hors du commun dans un ancien site minier au cœur du Val d'Argent. Entre exploration souterraine, défis collaboratifs et activités insolites, les équipes évoluent dans un environnement spectaculaire mêlant patrimoine, aventure et coopération. Ce lieu atypique permet également d'organiser séminaires, journées d'entreprise et événements sur mesure grâce à ses espaces de réception, ses salles équipées et ses nombreuses activités adaptées aux groupes. Une expérience immersive idéale pour renforcer la cohésion dans un cadre totalement dépaysant.",
  objectifs: ["cohesion", "communication", "leadership"],
  univers: ["wtf", "culture", "sport"],
  env: ["indoor", "outdoor"],
  format: ["demijournee", "journee"],
  saison: ["toutesaisons"],
  prixMin: 35,
  ...
  emoji: "⛏️",
  gradient: "linear-gradient(135deg, #4B5563, #B08968)",
  image: "images/mine-tellure.webp",
  tags: [
    { label: "Cohésion", cls: "cat-cohesion" },
    { label: "Communication", cls: "cat-communication" },
    { label: "Leadership", cls: "cat-leadership" },
...
},
{
  ...
  revendiquee: false,
  offre: "gratuit",
  title: "Visite de distillerie & dégustation artisanale",
  location: "Steige",
  lat: 48.358247,
  lng: 7.241815,
  description: "Plongez dans les coulisses d'une distillerie artisanale alsacienne et découvrez toutes les étapes de fabrication des eaux-de-vie, liqueurs et spiritueux, de la préparation des fruits jusqu'aux alambics en cuivre. Cette visite guidée se conclut par une dégustation commentée permettant d'échanger autour des saveurs, des méthodes de production et du patrimoine local. Une activité conviviale idéale pour un team building, un séminaire ou une sortie d'entreprise à la découverte des savoir-faire d'Alsace.",
  objectifs: ["communication", "cohesion"],
  univers: ["gastronomie", "culture"],
  env: ["indoor"],
  format: ["demijournee"],
  ...
  duree: "1h30",
  emoji: "🥃",
  gradient: "linear-gradient(135deg, #6D4C41, #C49A6C)",
  image: "images/distillerie-nusbaumer.webp",
  tags: [
    { label: "Communication", cls: "cat-communication" },
    { label: "Cohésion", cls: "cat-cohesion" },
    { label: "Gastronomie & Vins", cls: "cat-gastronomie" },
...
},
{
  ...
  lat: 48.1959,
  lng: 7.3197,
  description: "Initiez vos équipes au brassage de bière artisanale lors d'un atelier immersif animé par un brasseur professionnel. Répartis en binômes, les participants réalisent leur propre brassin à partir des matières premières, choisissent parmi plusieurs recettes et personnalisent leurs étiquettes. L'expérience est ponctuée d'une initiation à la biérologie, de dégustations commentées et d'un moment convivial autour de planches à partager. Chaque équipe repart avec sa propre bière artisanale, conditionnée en bouteilles ou en mini-fûts. Une activité originale qui favorise la communication, la créativité et la cohésion dans une ambiance chaleureuse.",
  objectifs: ["communication", "cohesion", "innovation"],
  univers: ["gastronomie", "creatif"],
  env: ["indoor"],
  format: ["demijournee"],
  saison: ["toutesaisons"],
  ...
  duree: "4h à 5h",
  emoji: "🍺",
  gradient: "linear-gradient(135deg, #B9770E, #F4D03F)",
  image: "images/brasserie-comptoirdubrasseur.webp",
  tags: [
    { label: "Communication", cls: "cat-communication" },
    { label: "Cohésion", cls: "cat-cohesion" },
    { label: "Innovation", cls: "cat-innovation" },
...
},
{
  ...
  revendiquee: false,
  offre: "gratuit",
  title: "Forgez votre propre couteau",
  location: "Munster",
  lat: 48.0396,
  lng: 7.1397,
  description: "Vivez une immersion exceptionnelle dans l'univers de la coutellerie artisanale en forgeant votre propre couteau, droit ou pliant, à partir d'un lopin d'acier. Accompagnés par des artisans passionnés, les participants découvrent toutes les étapes de fabrication : forge, usinage, traitements thermiques, façonnage du manche en bois local, assemblage, affûtage et finitions. Chaque personne repart avec une pièce unique entièrement réalisée de ses mains. Une expérience authentique, idéale pour les petits groupes souhaitant partager un moment hors du commun autour du savoir-faire artisanal alsacien.",
  objectifs: ["innovation", "communication"],
  univers: ["creatif", "culture"],
  env: ["indoor"],
  format: ["journee"],
  saison: ["toutesaisons"],
  ...
  duree: "10h",
  emoji: "🔨",
  gradient: "linear-gradient(135deg, #434343, #B08D57)",
  image: "images/forge-coutellerie.webp",
  tags: [
    { label: "Innovation", cls: "cat-innovation" },
    { label: "Communication", cls: "cat-communication" },
    { label: "Artistique & Créatif", cls: "cat-creatif" },
...
},
{
  ...
  revendiquee: false,
  offre: "gratuit",
  title: "Stage bushcraft & survie en équipe",
  location: "Vallée de la Bruche",
  lat: 48.4228,
  lng: 7.2215,
  description: "Plongez vos équipes dans une véritable expérience de survie au cœur de la Vallée de la Bruche. Durant une journée, les participants découvrent les fondamentaux du bushcraft et apprennent à réagir en milieu naturel : orientation, priorités en survie, réalisation de nœuds, construction d'un abri, allumage du feu, recherche et potabilisation de l'eau. Encadré par un professionnel, cet atelier outdoor développe l'entraide, la prise de décision, l'adaptation et la coopération dans un environnement naturel exceptionnel. Une activité idéale pour renforcer la cohésion tout en vivant une aventure hors des sentiers battus.",
  objectifs: ["cohesion", "leadership", "communication"],
  univers: ["nature", "sport"],
  env: ["outdoor"],
  format: ["journee"],
  saison: ["printempsete"],
  ...
  duree: "1 journée",
  emoji: "🔥",
  gradient: "linear-gradient(135deg, #355C3D, #A67C52)",
  image: "images/bushcraft-bruche.webp",
  tags: [
    { label: "Cohésion", cls: "cat-cohesion" },
    { label: "Leadership", cls: "cat-leadership" },
    { label: "Communication", cls: "cat-communication" },
...
},
{
  ...
  revendiquee: false,
  offre: "gratuit",
  title: "Atelier percussions brésiliennes (Batucada)",
  location: "Alsace",
  lat: 48.280,
  lng: 7.450,
  description: "Faites vibrer vos équipes au rythme de la Batucada, un atelier de percussions brésiliennes où chaque participant contribue à la création d'une œuvre musicale collective. Guidés par un chef d'orchestre, les collaborateurs découvrent différents instruments traditionnels avant d'apprendre à écouter, se synchroniser et jouer ensemble. Accessible sans aucune expérience musicale, cette animation développe la communication, l'entraide et la cohésion dans une ambiance festive et énergique. Une activité idéale pour dynamiser un séminaire, renforcer l'esprit d'équipe et partager une expérience mémorable.",
  objectifs: ["communication", "cohesion", "leadership"],
  univers: ["creatif", "wtf"],
  env: ["indoor"],
  format: ["demijournee"],
  ...
  duree: "1h30 à 2h",
  emoji: "🥁",
  gradient: "linear-gradient(135deg, #D35400, #F39C12)",
  image: "images/batucada-percussions.webp",
  tags: [
    { label: "Communication", cls: "cat-communication" },
    { label: "Cohésion", cls: "cat-cohesion" },
    { label: "Leadership", cls: "cat-leadership" },
...
},
{
  ...
  revendiquee: false,
  offre: "gratuit",
  title: "Simulation de pilotage automobile",
  location: "Colmar",
  lat: 48.0793,
  lng: 7.3585,
  description: "Installez vos équipes dans des simulateurs de conduite ultra réalistes pour vivre une expérience de pilotage immersive. Les participants s'affrontent sur des circuits virtuels avec classement en temps réel. Ce format stimule la concentration, la gestion du stress et l'esprit de compétition. Accessible à tous, il crée une expérience engageante et moderne.",
  objectifs: ["stress", "cohesion"],
  univers: ["sport", "jeux"],
  env: ["indoor"],
  format: ["moins2h"],
  ...
  image: "images/simulateur-pilotage.webp",
  tags: [
    { label: "Gestion du stress", cls: "cat-stress" },
    { label: "Cohésion", cls: "cat-cohesion" },
    { label: "Sport & Adrénaline", cls: "cat-sport" },
...
},
{
  ...
  revendiquee: false,
  offre: "gratuit",
  title: "Immersion apiculteur & ruche",
  location: "Sélestat",
  lat: 48.259,
  lng: 7.454,
  description: "Partez à la rencontre des abeilles lors d'un atelier immersif avec un apiculteur. Les équipes découvrent le fonctionnement d'une ruche et participent à certaines étapes de production du miel. Cette activité sensibilise à l'environnement tout en favorisant l'échange et la coopération. Une expérience pédagogique et apaisante, idéale pour créer du lien autrement.",
  objectifs: ["cohesion", "innovation"],
  univers: ["wtf", "culture", "nature"],
  env: ["outdoor"],
  format: ["moins2h"],
  saison: ["printempsete"],
  prixMin: 40,
  ...
  image: "images/immersion-apiculteur.webp",
  tags: [
    { label: "Cohésion", cls: "cat-cohesion" },
    { label: "Innovation", cls: "cat-innovation" },
    { label: "What the Fuck", cls: "cat-wtf" },
...
},
{
  ...
  revendiquee: false,
  offre: "gratuit",
  title: "Atelier mixologie & création de cocktails",
  location: "Strasbourg",
  lat: 48.5734,
  lng: 7.7521,
  description: "Initiez vos équipes à l'art de la mixologie en créant leurs propres cocktails. Les participants expérimentent différentes associations de saveurs et techniques de préparation. Ce format encourage la créativité, la collaboration et la prise d'initiative. L'activité se déroule dans une ambiance conviviale et détendue, idéale pour renforcer les liens.",
  objectifs: ["cohesion", "innovation"],
  univers: ["gastronomie", "creatif"],
  env: ["indoor"],
  format: ["moins2h"],
  ...
  image: "images/atelier-mixologie.webp",
  tags: [
    { label: "Cohésion", cls: "cat-cohesion" },
    { label: "Innovation", cls: "cat-innovation" },
    { label: "Gastronomie & Vins", cls: "cat-gastronomie" },
...
},
{
  ...
  revendiquee: false,
  offre: "gratuit",
  title: "Atelier céramique au tour",
  location: "Strasbourg",
  lat: 48.5734,
  lng: 7.7521,
  description: "Découvrez le travail de la terre à travers un atelier de tournage céramique. Les participants apprennent à façonner leurs propres pièces sur un tour. Ce format favorise la concentration, la créativité et l'entraide dans un cadre apaisant. Chaque participant repart avec sa création, souvenir tangible de l'expérience.",
  objectifs: ["cohesion", "communication"],
  univers: ["creatif", "bienetre"],
  env: ["indoor"],
  format: ["moins2h"],
  ...
  image: "images/ceramique-tour.webp",
  tags: [
    { label: "Cohésion", cls: "cat-cohesion" },
    { label: "Communication", cls: "cat-communication" },
    { label: "Artistique & Créatif", cls: "cat-creatif" },
...
var villeMap = {
    ...
    vosges: ['vosges', 'massif', 'obernai', 'munster', 'hohneck', 'schlucht', 'orbey', 'gérardmer', 'thann', 'la bresse', 'husseren-wesserling', 'steige', 'bruche']
  };
